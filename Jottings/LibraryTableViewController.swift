...
class LibraryTableViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    var fetchedResultsController: NSFetchedResultsController {
        ...
        let entity = NSEntityDescription.entityForName("Jotting", inManagedObjectContext: self.managedObjectContext!)
        ...
        let sortDescriptor = NSSortDescriptor(key: "lastChanged", ascending: false)
